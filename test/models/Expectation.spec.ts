        ...
        describe('GIVEN toHaveBeenCalledWithFirst', () => {
            ...
            describe('WHEN a true expectation is made', () => {
                ...
                it('THEN it evaluates to true', () => {
                    ...
                    Math.round(2);
                    expectation = new Expectation(testSpy, 'Description');
                    expect(expectation.toHaveBeenCalledWithFirst(1)).to.be.true;
                });
            ...
            describe('WHEN a false expectation is made', () => {
                ...
                it('THEN it evaluates to false', () => {
                    Math.round(1);
                    expectation = new Expectation(testSpy, 'Description');
                    expect(expectation.toHaveBeenCalledWithFirst(2)).to.be.false;
                });
        ...
        describe('GIVEN toHaveBeenCalledWithLast', () => {
            ...
            describe('WHEN a true expectation is made', () => {
                ...
                it('THEN it evaluates to true', () => {
                    ...
                    Math.round(2);
                    expectation = new Expectation(testSpy, 'Description');
                    expect(expectation.toHaveBeenCalledWithLast(2)).to.be.true;
                });
            ...
            describe('WHEN a false expectation is made', () => {
                ...
                it('THEN it evaluates to false', () => {
                    ...
                    Math.round(1);
                    expectation = new Expectation(testSpy, 'Description');
                    expect(expectation.toHaveBeenCalledWithLast(2)).to.be.false;
                });
